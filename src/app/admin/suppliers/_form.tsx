  ...
  return (
    <Card>
      <form action={formAction}>
        <FormSection title="Identity" description="Basic supplier information.">
          <Field label="Supplier code" htmlFor="code" error={fieldError(fe, "code")} hint="Auto-generated if blank.">
            <Input id="code" name="code" defaultValue={defaults?.code ?? ""} placeholder="SUP-0001" />
          </Field>
          ...
          <Field label="Active" htmlFor="active">
            <label className="flex h-10 items-center gap-2 text-sm text-ink-dim">
              ...
              />
              <span>Available for new purchase orders</span>
            </label>
          </Field>
        </FormSection>

        <FormSection title="Address & terms" description="How and when you settle with this supplier.">
          ...
          <Field
            ...
            hint="Days from invoice to due. NET 30 = 30."
          >
            <Input
              id="paymentTermsDays"
